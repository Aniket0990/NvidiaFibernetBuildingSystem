...
public class UserDashBoard extends JFrame
{
	...
	public JPanel createAccountDetailsPanel() throws SQLException
	{
		...
		planPanel.add(Box.createRigidArea(new Dimension(0, 100)));
		...
		duePanel.add(Box.createRigidArea(new Dimension(0, 100)));
		...
		usageLabel.setFont(new Font("Arial",Font.PLAIN,16));
		usagePanel.add(usageLabel);
		usagePanel.add(Box.createRigidArea(new Dimension(0, 100)));
