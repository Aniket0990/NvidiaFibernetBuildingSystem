...
public class AdminDashboard extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ResultSet rs = con.s.executeQuery(
							"Select planPrice from broadband_plans where accountNumber = '" + accountNo + "';");
		...
		generateBill.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (i > 0) {
						JOptionPane.showMessageDialog(AdminDashboard.this, "Bill Generated Successfully !!!", "Success",
								JOptionPane.PLAIN_MESSAGE);
					} else {
						JOptionPane.showMessageDialog(AdminDashboard.this, "Bill was not Generated !!!", "Error",
								JOptionPane.PLAIN_MESSAGE);
					}
	...
	public JPanel addAccountDetailsPanel() {
		...
		String[] columnNames = { "Mobile Number", "User Name", "Plan Type", "Plan Price", "Account Number" };
	...
	public JPanel createProfilePanel() {
		...
		updateProfileButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String query = "Update admin_sign_in set username = '" + adminName + "' where password = '" + password
						+ "';";
				...
				try {
					...
					if (i > 0) {
						JOptionPane.showMessageDialog(AdminDashboard.this, "Admin Profile Updated Successfully !!",
								"Success", JOptionPane.OK_OPTION);
					} else {
						JOptionPane.showMessageDialog(AdminDashboard.this, "Admin Profile is not Updated !!", "Error",
	...
	public void fetchUserDetails() {
		...
		String query = "SELECT sign_in.mobileNumber, sign_in.userName, broadband_plans.planType, broadband_plans.planPrice, broadband_plans.accountNumber FROM sign_in JOIN broadband_plans ON sign_in.mobileNumber = broadband_plans.mobileNumber;";
